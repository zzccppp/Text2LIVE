...
sweep_configuration = {
    ...
    "parameters": {
        ...
        "n_epochs": {"values": [200, 400, 600, 800, 1000]},
    },
}

sweep_id = wandb.sweep(sweep=sweep_configuration, project="text2live")


def main():
    args = Arguments()
    args.config = "./configs/image_config.yaml"
    args.example_config = "golden_horse.yaml"
